...
| appServicePlanSku      | string | No       | The Name of AppServicePlan Sku allowedValues":  "allowedValues": [<br/>"S1", Standard<br/>"S2", Standard<br/>"S3", Standard<br/>"P1V2", Premium V2<br/>"P2V2", Premium V2<br/>"P3V2", Premium V2<br/>"Y1", Dynamic consumption plan ]
...
| appSettings            | array  | No       | The SiteConfig's appSettings of the functionApp   "defaultValue": [ <br/>{<br/> "name": "FUNCTIONS_WORKER_RUNTIME",<br/> "value": "python"<br/> }, {  "name": "FUNCTIONS_EXTENSION_VERSION",<br/>"value": "~4"<br/>}]<br/><br/>Note:  appSettings must at least contains value for FUNCTIONS_WORKER_RUNTIME and FUNCTIONS_EXTENSION_VERSION
| stackName | string | No | Runtime language, "defaultValue": "PYTHON"
| stackVersion | string | No | Runtime language version, "defaultValue": "3.10"<br/>Get a list of supported runtimes with<br/>`az functionapp list-runtimes --os linux -o table` |
