...
| appGatewayIp                      | String | Yes      | Ip address the security restriction bypass is valid for. empty string means no bypass |
...
| privateDnsZoneId                  | String | No       | The resourceId of a private dns-zone                                                  |
